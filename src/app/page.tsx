    ...
    <div style={{
      ...
      <footer style={{ position: "relative", zIndex: 1, textAlign: "center", padding: "20px 24px 32px", borderTop: "1px solid rgba(255,255,255,0.04)" }}>
        <div style={{ fontSize: 11, fontFamily: "monospace", color: "#1C2A3A" }}>
          Powered by LI.FI &nbsp;·&nbsp; ETH &nbsp;·&nbsp; MATIC &nbsp;·&nbsp; BNB &nbsp;·&nbsp; ARB &nbsp;·&nbsp; OP &nbsp;·&nbsp; Beta v0.1 &nbsp;·&nbsp; <a href="/privacy" style={{ color: "#3D4F6B", textDecoration: "none" }}>Privacy Policy</a> &nbsp;·&nbsp; <a href="/privacy" style={{ color: "#3D4F6B", textDecoration: "none" }}>Privacy Policy</a> &nbsp;·&nbsp; <a href="/privacy" style={{ color: "#3D4F6B", textDecoration: "none" }}>Privacy Policy</a> &nbsp;·&nbsp; <a href="/privacy" style={{ color: "#3D4F6B", textDecoration: "none" }}>Privacy Policy</a> &nbsp;·&nbsp; <a href="/privacy" style={{ color: "#3D4F6B", textDecoration: "none" }}>Privacy Policy</a> &nbsp;·&nbsp; <a href="/privacy" style={{ color: "#3D4F6B", textDecoration: "none" }}>Privacy Policy</a> &nbsp;·&nbsp; <a href="/privacy" style={{ color: "#3D4F6B", textDecoration: "none" }}>Privacy Policy</a> &nbsp;·&nbsp; <a href="/privacy" style={{ color: "#3D4F6B", textDecoration: "none" }}>Privacy Policy</a> &nbsp;·&nbsp; <a href="/privacy" style={{ color: "#3D4F6B", textDecoration: "none" }}>Privacy Policy</a> &nbsp;·&nbsp; <a href="/privacy" style={{ color: "#3D4F6B", textDecoration: "none" }}>Privacy Policy</a> &nbsp;·&nbsp; <a href="/privacy" style={{ color: "#3D4F6B", textDecoration: "none" }}>Privacy Policy</a> &nbsp;·&nbsp; <a href="/privacy" style={{ color: "#3D4F6B", textDecoration: "none" }}>Privacy Policy</a> &nbsp;·&nbsp; <a href="/privacy" style={{ color: "#3D4F6B", textDecoration: "none" }}>Privacy Policy</a> &nbsp;·&nbsp; <a href="/privacy" style={{ color: "#3D4F6B", textDecoration: "none" }}>Privacy Policy</a> &nbsp;·&nbsp; <a href="/privacy" style={{ color: "#3D4F6B", textDecoration: "none" }}>Privacy Policy</a> &nbsp;·&nbsp; <a href="/privacy" style={{ color: "#3D4F6B", textDecoration: "none" }}>Privacy Policy</a> &nbsp;·&nbsp; <a href="/privacy" style={{ color: "#3D4F6B", textDecoration: "none" }}>Privacy Policy</a>
        </div>
      </footer>
    </div>
  );
